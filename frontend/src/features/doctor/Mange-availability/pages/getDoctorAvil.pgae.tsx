...
import { CalendarPlus, Clock3, RefreshCw } from "lucide-react";
...
import type { CreateDoctorAvailability } from "../types/addDoctorAvail.type";
...
const ManageAvailability = () => {
  ...
  const handleCreateAvailability = async (
    ...
    return result.payload ?? "Failed to create availability.";
  };

  const handleEditAvailability = (row: DoctorAvailability) => {
  ...
  const handleUpdateAvailability = async (
    ...
    return result.payload ?? "Failed to update availability.";
  };

  const handleDeleteAvailability = (row: DoctorAvailability) => {
  ...
  const handleConfirmDelete = async () => {
    ...
    const result = await dispatch(deleteAvailability(selectedForDelete.id));
  ...
  return (
    ...
    >
      <main className="availability-page">
        <section className="availability-hero">
          <div>
            ...
            <p>
              Add and update your weekly consultation hours so patients can
        ...
        {isLoading ? (
          <section className="availability-loading-card">
            ...
            <p>Please wait while your availability is retrieved.</p>
          </section>
        ) : (
              ...
              <div className="availability-card-header">
                <div className="availability-card-title">
                  ...
                  <div>
                    ...
                    <p>
                      Your active appointment slots for patients.
                    </p>
                  </div>
                </div>
              ...
              <div className="availability-card-header">
                <div className="availability-card-title">
                  ...
                  <div>
                    ...
                    <p>Dates follow your weekly availability.</p>
                  </div>
                </div>
              </div>
      ...
      <DeleteAvailabilityModal
        ...
        dayOfWeek={selectedForDelete?.dayOfWeek}
